package com.pescaria.course.resources.exceptions;
...
public class ResourceExceptionHandler {
	@ExceptionHandler(ResourceNotFoundException.class) //Qualquer exceção desse tipo será interceptado por essa classe
